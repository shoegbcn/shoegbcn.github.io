...
t.exports=AFRAME.registerComponent("cube-env-map", {
  ...
  init: function() {
    ...
    this.texture = new THREE.CubeTextureLoader().load([
      "../env/posx." + t.extension,
      "../env/negx." + t.extension,
      "../env/posy." + t.extension,
      "../env/negy." + t.extension,
      "../env/posz." + t.extension,
      "../env/negz." + t.extension
    ]);
  ...
  update: function(e) {
    ...
    t.enableBackground && !e.enableBackground
      ? this.setBackground(this.texture)
      : !t.enableBackground && e.enableBackground && this.setBackground(null);
  },
  remove: function() {
    this.el.removeEventListener("object3dset", this.object3dsetHandler);
    var e = this.el.getObject3D("mesh"),
      t = this.data;
    n(e, t.materials, null, 1), t.enableBackground && this.setBackground(null);
  },
